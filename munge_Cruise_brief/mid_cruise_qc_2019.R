rm(list=ls())
# SET UP ------------------------------------------------------------------
setwd("/Users/ivor.williams/Documents/CRED/Fish Team/Cruises/ASRAMP18")
...
x<-read.csv("FISH REA BASE 061318.csv")    #NB... 'REA FISH BASE FOR R' IS THE ACCESS QUERY THAT GENERATES OUTPUT TO MATCH THE DATA_COLS ABOVE
...
"FAMILY" , "COMMONFAMILYALL", "LMAX", "LW_A",  "LW_B",  "LENGTH_CONVERSION_FACTOR", "TROPHIC", "TRAINING_YN")
head(x[,DATA_COLS])
x<-x[,DATA_COLS]

x$TROPHIC_MONREP<-"FIELD BLANK"
